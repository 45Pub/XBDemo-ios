...
{
    return [[self elementForName:@"MOBILEPHONE"] stringValue];
}

- (void)setMobilePhone:(NSString *)mobilePhone
{
    XMPP_VCARD_SET_STRING_CHILD(mobilePhone, @"MOBILEPHONE");
}

- (NSString *)fixedPhone
{
    return [[self elementForName:@"FIXEDPHONE"] stringValue];
}

- (void)setFixedPhone:(NSString *)fixedPhone
{
    XMPP_VCARD_SET_STRING_CHILD(fixedPhone, @"FIXEDPHONE");
}
