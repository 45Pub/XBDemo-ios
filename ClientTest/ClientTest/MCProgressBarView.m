...
- (id)initWithFrame:(CGRect)frame backgroundImage:(UIImage *)backgroundImage foregroundImage:(UIImage *)foregroundImage
{
    ...
    if (self) {
		...
		_backgroundImageView.autoresizingMask = UIViewAutoresizingFlexibleWidth|UIViewAutoresizingFlexibleRightMargin;
...
- (void)layoutSubviews
{
    ...
    frame.size.width = roundf(minimumForegroundWidth + availableWidth * _progress);
